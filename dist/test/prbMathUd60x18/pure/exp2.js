...
function shouldBehaveLikeExp2() {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.contracts.prbMathUd60x18.doExp2(x)];
                        case 1:
                            _b.apply(_a, [_e.sent()]);
                            _d = (_c = chai_1.expect(expected).to).equal;
                            return [4 /*yield*/, this.contracts.prbMathUd60x18Typed.doExp2(x)];
                        case 2:
                            _d.apply(_c, [_e.sent()]);
                            return [2 /*return*/];
                    }
    ...
    context("when x is positive", function () {
        context("when x is greater than or equal to 192", function () {
            var testSets = [evm_fp_1.default("192"), evm_fp_1.default(constants_1.MAX_WHOLE_UD60x18), evm_fp_1.default(constants_1.MAX_UD60x18)];
            mocha_each_1.default(testSets).it("takes %e and reverts", function (x) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18.doExp2(x)).to.be.reverted];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18Typed.doExp2(x)).to.be.reverted];
                            case 2:
                                _a.sent();
                                return [2 /*return*/];
                        }
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.contracts.prbMathUd60x18.doExp2(evm_fp_1.default(x))];
                            case 1:
                                _b.apply(_a, [_e.sent()]);
                                _d = (_c = chai_1.expect(expected).to.be).near;
                                return [4 /*yield*/, this.contracts.prbMathUd60x18Typed.doExp2(evm_fp_1.default(x))];
                            case 2:
                                _d.apply(_c, [_e.sent()]);
                                return [2 /*return*/];
                        }
