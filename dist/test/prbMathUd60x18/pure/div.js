...
function shouldBehaveLikeDiv() {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            y = numbers_1.bn("0");
                            return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18.doDiv(x, y)).to.be.reverted];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18Typed.doDiv(x, y)).to.be.reverted];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    context("when the denominator is not zero", function () {
        context("when the numerator is zero", function () {
            var testSets = ["1e-18", "1", constants_1.PI, "1e18"];
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.contracts.prbMathUd60x18.doDiv(x, evm_fp_1.default(y))];
                            case 1:
                                _b.apply(_a, [_e.sent()]);
                                _d = (_c = chai_1.expect(expected).to).equal;
                                return [4 /*yield*/, this.contracts.prbMathUd60x18Typed.doDiv(x, evm_fp_1.default(y))];
                            case 2:
                                _d.apply(_c, [_e.sent()]);
                                return [2 /*return*/];
                        }
        ...
        context("when the numerator is not zero", function () {
            context("when the scaled numerator overflows", function () {
                var testSets = [
                    [evm_fp_1.default(constants_1.MAX_UD60x18).div(evm_fp_1.default(constants_1.SCALE)).add(1), evm_fp_1.default("1e-18")],
                    [evm_fp_1.default(constants_1.MAX_UD60x18).div(evm_fp_1.default(constants_1.SCALE)).add(1), evm_fp_1.default("1e-18")],
                ];
                mocha_each_1.default(testSets).it("takes %e and %e and reverts", function (x, y) {
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18.doDiv(x, y)).to.be.reverted];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18Typed.doDiv(x, y)).to.be.reverted];
                                case 2:
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                case 0:
                                    ...
                                    _b = (_a = chai_1.expect(expected).to).equal;
                                    return [4 /*yield*/, this.contracts.prbMathUd60x18.doDiv(evm_fp_1.default(x), evm_fp_1.default(y))];
                                case 1:
                                    _b.apply(_a, [_e.sent()]);
                                    _d = (_c = chai_1.expect(expected).to).equal;
                                    return [4 /*yield*/, this.contracts.prbMathUd60x18Typed.doDiv(evm_fp_1.default(x), evm_fp_1.default(y))];
                                case 2:
                                    _d.apply(_c, [_e.sent()]);
                                    return [2 /*return*/];
                            }
