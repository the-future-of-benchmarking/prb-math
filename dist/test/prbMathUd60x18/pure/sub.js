...
function shouldBehaveLikeSub() {
    context("when the difference underflows", function () {
        var testSets = [
            [numbers_1.bn("1"), numbers_1.bn("2")],
            [evm_fp_1.default(constants_1.MAX_UD60x18).div(2), evm_fp_1.default(constants_1.MAX_UD60x18).div(2).add(1)],
            [evm_fp_1.default(constants_1.MAX_UD60x18).sub(numbers_1.bn("1")), constants_1.MAX_UD60x18],
        ];
        mocha_each_1.default(testSets).it("takes %e and %e and reverts", function (x, y) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18Typed.doSub(x, y)).to.be.reverted];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    context("when the difference does not underflow", function () {
        ...
        mocha_each_1.default(testSets).it("takes %e and %e and returns the correct value", function (x, y) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.contracts.prbMathUd60x18Typed.doSub(x, y)];
                        case 1:
                            result = _a.sent();
                            expected = x.sub(y);
