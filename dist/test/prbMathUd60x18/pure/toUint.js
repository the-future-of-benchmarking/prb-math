...
function shouldBehaveLikeToUint() {
    context("when x is less than the scale", function () {
        var testSets = [[numbers_1.bn("0")], [numbers_1.bn("1")], [evm_fp_1.default(constants_1.SCALE).sub(1)]];
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.contracts.prbMathUd60x18.doToUint(x)];
                        case 1:
                            _b.apply(_a, [_e.sent()]);
                            _d = (_c = chai_1.expect(expected).to).equal;
                            return [4 /*yield*/, this.contracts.prbMathUd60x18Typed.doToUint(x)];
                        case 2:
                            _d.apply(_c, [_e.sent()]);
                            return [2 /*return*/];
                    }
    ...
    context("when x is greater than or equal to the scale", function () {
        var testSets = [
            [evm_fp_1.default(constants_1.SCALE)],
            [evm_fp_1.default(constants_1.SCALE).add(1)],
            [evm_fp_1.default(constants_1.SCALE).mul(2).sub(1)],
            [evm_fp_1.default(constants_1.SCALE).mul(2)],
...
exports.default = shouldBehaveLikeToUint;
//# sourceMappingURL=toUint.js.map