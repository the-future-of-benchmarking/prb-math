...
function shouldBehaveLikeLog10() {
    context("when x is less than 1", function () {
        var testSets = [numbers_1.bn("0"), evm_fp_1.default("1e-18"), evm_fp_1.default("1e-17"), evm_fp_1.default("1e4"), evm_fp_1.default("0.1"), evm_fp_1.default("0.5"), evm_fp_1.default(constants_1.SCALE).sub(1)];
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            x = numbers_1.bn("0");
                            return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18.doLog10(x)).to.be.reverted];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, chai_1.expect(this.contracts.prbMathUd60x18Typed.doLog10(x)).to.be.reverted];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    context("when x is greater than or equal to 1", function () {
        context("when x is a power of ten", function () {
            var testSets = [["1"], ["10"], ["100"], ["1e18"], ["1e49"], ["1e57"], ["1e58"]];
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.contracts.prbMathUd60x18.doLog10(evm_fp_1.default(x))];
                            case 1:
                                _b.apply(_a, [_e.sent()]);
                                _d = (_c = chai_1.expect(expected).to).equal;
                                return [4 /*yield*/, this.contracts.prbMathUd60x18Typed.doLog10(evm_fp_1.default(x))];
                            case 2:
                                _d.apply(_c, [_e.sent()]);
                                return [2 /*return*/];
                        }
        ...
        context("when x is not a power of ten", function () {
            var testSets = [
                ...
                [constants_1.MAX_WHOLE_UD60x18],
                [constants_1.MAX_UD60x18],
            ];
            mocha_each_1.default(testSets).it("takes %e and returns the correct value", function (x) {
                return __awaiter(this, void 0, void 0, function () {
                    var expected, _a, _b, _c, _d;
