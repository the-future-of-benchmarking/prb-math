...
function shouldBehaveLikeSqrt() {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.contracts.prbMathSd59x18.doSqrt(x)];
                        case 1:
                            _b.apply(_a, [_e.sent()]);
                            _d = (_c = chai_1.expect(expected).to).equal;
                            return [4 /*yield*/, this.contracts.prbMathSd59x18Typed.doSqrt(x)];
                        case 2:
                            _d.apply(_c, [_e.sent()]);
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, chai_1.expect(this.contracts.prbMathSd59x18.doSqrt(x)).to.be.reverted];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, chai_1.expect(this.contracts.prbMathSd59x18Typed.doSqrt(x)).to.be.reverted];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    context("when x is positive", function () {
        context("when x is greater than or equal to 57896044618658097711785492504343953926634.992332820282019729", function () {
            var testSets = [
                evm_fp_1.default("57896044618658097711785492504343953926634.992332820282019729"),
            ...
            mocha_each_1.default(testSets).it("takes %e and reverts", function (x) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, chai_1.expect(this.contracts.prbMathSd59x18.doSqrt(x)).to.be.reverted];
                            case 1:
                                _a.sent();
                                return [4 /*yield*/, chai_1.expect(this.contracts.prbMathSd59x18Typed.doSqrt(x)).to.be.reverted];
                            case 2:
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                ...
                                _b = (_a = chai_1.expect(expected).to).equal;
                                return [4 /*yield*/, this.contracts.prbMathSd59x18.doSqrt(evm_fp_1.default(x))];
                            case 1:
                                _b.apply(_a, [_e.sent()]);
                                _d = (_c = chai_1.expect(expected).to).equal;
                                return [4 /*yield*/, this.contracts.prbMathSd59x18Typed.doSqrt(evm_fp_1.default(x))];
                            case 2:
                                _d.apply(_c, [_e.sent()]);
                                return [2 /*return*/];
                        }
