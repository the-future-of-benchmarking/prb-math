...
function shouldBehaveLikeAbs() {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.contracts.prbMathSd59x18.doAbs(x)];
                        case 1:
                            _b.apply(_a, [_e.sent()]);
                            _d = (_c = chai_1.expect(expected).to).equal;
                            return [4 /*yield*/, this.contracts.prbMathSd59x18Typed.doAbs(x)];
                        case 2:
                            _d.apply(_c, [_e.sent()]);
                            return [2 /*return*/];
                    }
    ...
    context("when x is not zero", function () {
        context("when x is negative", function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, chai_1.expect(this.contracts.prbMathSd59x18.doAbs(x)).to.be.reverted];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, chai_1.expect(this.contracts.prbMathSd59x18Typed.doAbs(x)).to.be.reverted];
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
            ...
            context("when x > min sd59x18", function () {
                var testSets = [
                    [evm_fp_1.default(constants_1.MIN_SD59x18).add(1)],
                    [evm_fp_1.default(constants_1.MIN_WHOLE_SD59x18)],
                    [evm_fp_1.default("-1e18")],
                    [evm_fp_1.default("-4.2")],
                    [evm_fp_1.default("-2")],
                    [evm_fp_1.default(constants_1.PI).mul(-1)],
                    [evm_fp_1.default("-1.125")],
                    [evm_fp_1.default("-1")],
                    [evm_fp_1.default("-0.5")],
...
exports.default = shouldBehaveLikeAbs;
