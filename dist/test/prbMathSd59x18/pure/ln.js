            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            x = numbers_1.bn("0");
                            return [4 /*yield*/, chai_1.expect(this.contracts.prbMathSd59x18.doLn(x)).to.be.reverted];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, chai_1.expect(this.contracts.prbMathSd59x18Typed.doLn(x)).to.be.reverted];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.contracts.prbMathSd59x18.doLn(evm_fp_1.default(x))];
                        case 1:
                            _b.apply(_a, [_e.sent()]);
                            _d = (_c = chai_1.expect(expected).to.be).near;
                            return [4 /*yield*/, this.contracts.prbMathSd59x18Typed.doLn(evm_fp_1.default(x))];
                        case 2:
                            _d.apply(_c, [_e.sent()]);
                            return [2 /*return*/];
                    }
